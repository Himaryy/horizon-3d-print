...
export const Route = createFileRoute('/admin/products/new-product')({
...
function NewProductPage() {
  ...
  const form = useForm({
    defaultValues: {
      ...
      price: 0,
      stock: 0,
      category: 'READY_MADE' as 'READY_MADE' | 'CUSTOM_BASE',
      isPublished: false,
      isFeatured: false,
      modelUrl: '',
      videoUrl: '',
    ...
    <div className="space-y-6">
      <div className="flex items-center gap-4">
        ...
        <div>
          ...
          <p className="mt-1 text-sm text-fog">Fill in the product details</p>
        </div>
      </div>
